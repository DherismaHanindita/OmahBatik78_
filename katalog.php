      ...
      <!-- BEGIN SIDEBAR & CONTENT -->
        ...
        <!-- END SALE PRODUCT & NEW ARRIVALS -->
            ...
            <?php 
              ...
              $querypro1 = mysqli_query($connect, "SELECT * FROM barang a, jenis b, kategori c where a.id_kategori = c.id_kategori and a.id_jenis = b.id_jenis");
              $row = mysqli_num_rows($querypro1);
              $hitung = $row;
              $batas = 8;
              $page = $_GET['hal'];
              if(isset($_GET['hal']))
              ...
              $querypro = mysqli_query($connect, "SELECT * FROM barang a, jenis b, kategori c where a.id_kategori = c.id_kategori and a.id_jenis = b.id_jenis  ORDER BY id_barang DESC LIMIT $offset, $batas");
                      ...
                      <nav>
                        <ul class="pagination pagination-lg">
                          <?php
                              ...
                              {
                                 $last = $page - 2;
                                 echo "<li><a href='index.php?page=katalog&hal=$last' class='btn btn-default'>Prev</a></li>";
                                 echo "<li><a href='index.php?page=katalog&hal=$page' class='btn btn-default pull_right'>Next</a></li>";
                              }
                              else if( $page == 0 )
                              {
                                 echo "<li><a href='index.php?page=katalog&hal=$page' class='btn btn-default pull_right'>Next</a></li>";

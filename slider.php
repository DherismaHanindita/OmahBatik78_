      ...
      <div id="layerslider" style="width: 100%; height: 494px; margin: 0 auto;">
        ...
        <div class="ls-slide ls-slide1" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 24,25,27,28;">
          ...
          <div class="ls-l ls-title" style="top: 96px; left: 35%; white-space: nowrap;" data-ls="
            ...
            scaleout: .5; 
            showuntil: 4000;
          ">Distro <strong>Batik Pekalongan</strong></div>
          ...
          delayin: 300; 
          showuntil: 4000;
          ">Pusatnya batik kekinian di pekalongan.
          </div>
        </div>
        <!-- slide one end -->
        ...
        <div class="ls-slide ls-slide2" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 110,111,112,113;">
          ...
          scaleout: .5; 
          showuntil: 4000;
          "><strong>Kualitas</strong> yang kami prioritaskan <em>Harga mulai dari</em>
            </div>
          ...
          scalein: .8; 
          scaleout: .8; 
          showuntil: 4000;"><b>.</b> <strong>100<sup>rb</sup></strong>
          </div>

          <a href="index.php?page=katalog" class="ls-l ls-more" style="top: 72%; left: 21%; display: inline-block; white-space: nowrap;" data-ls="
          fade: true; 
          fadeout: true; 
          durationin: 750; 
          durationout: 750; 
          ...
          scalein: .5; 
          scaleout: .5; 
          showuntil: 4000;">Selamat Berbelanja
          </a>
        </div>
        <!-- slide two end -->
        ...
        <div class="ls-slide ls-slide3" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 92,93,105;">
          ...
          scaleout: .5; 
          showuntil: 4000;
          ">Menyediakan Batik-batik <strong>Berkualitas</strong> Yang cocok untuk anda
          </div>
          ...
          showuntil: 4000;
          ">
            <a href="index.php?page=katalog" class="ls-buy">
              Beli sekarang!
            </a>
          </div>
        </div>
